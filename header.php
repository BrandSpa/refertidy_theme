...
<head>
	...
	<link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/fonts/brandon.css">
	<link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/fonts/assistant.css">
